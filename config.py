...
SILICONFLOW_API_KEY = os.environ.get("SILICONFLOW_API_KEY", "Bearer sk-qkmvspzkqyjbmrlgxlefwnlcrctztszblvusumgpmjhqonre")
SILICONFLOW_BASE_URL = os.environ.get("SILICONFLOW_BASE_URL", "https://api.siliconflow.cn/v1")
SILICONFLOW_MODEL = os.environ.get("SILICONFLOW_MODEL", "Qwen/Qwen3.5-397B-A17B")

RECOMMEND_CACHE_ENABLED = os.environ.get("RECOMMEND_CACHE_ENABLED", "true")
